...
\pres[logo=logo/unistra.png,url=https://www.unistra.fr/]{Université de Strasbourg}
%
% Nom (argument obligatoire) de l'institut (principal en cas de cotutelle)
\institute[logo=logo/ed414.png,url=http://ed.vie-sante.unistra.fr/]{Université de Strasbourg}
%
...
\examiner[female,affiliation=Directrice de recherche INSERM Paris]{Gisèle}{Bonne}
